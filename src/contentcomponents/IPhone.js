...
import { ContentShow, Header, Paragraph, Image, ContentCategory, LessContent, ZigZag } from "../ContentHelpers";
...
const iPhonePage = () => {
  return (
    <Fragment>
      <ContentShow less>
        <LessContent header={header}>I enjoy taking pictures on my iPhone</LessContent>
      ...
      <ContentShow containerLarge more className="c-photos">
        ...
        <ZigZag>
          <Image alt="picture of a beach in Santa Monica California" src={iphonesantaMonicaBeach} />
        </ZigZag>
        <ZigZag>
          <Image alt="picture of kid jumping up" src={iphoneDavidBestIphonePic} />
        </ZigZag>
        <ZigZag>
        ...
        <ZigZag>
          <Image alt="picture of a sunset near a ski lift" src={iphonehumphreysSkiSunset} />
        </ZigZag>
        <ZigZag>
          <Image alt="picture of of the Grand Canyon in black and white" src={iphonegrandcanyonBlackandWhite} />
        </ZigZag>
        <ZigZag>
          <Image alt="picture of a sunset in Mexico" src={iphonemexicoSunset} />
        </ZigZag>
        <ZigZag>
          <Image alt="picture of girl infront of a blue sky " src={iphonenaebabe} />
        </ZigZag>
        <ZigZag>
          <Image alt="picture of Dome in snow" src={iphonenauDome} />
        </ZigZag>
        <ZigZag>
          <Image alt="picture of a jeep on a picturesque landscape" src={iphonelockettJeepLife} />
        </ZigZag>
        <ZigZag>
          <Image alt="picture of guy in sunglasses" src={iphonemelDaddy} />
        </ZigZag>
        <ZigZag>
          <Image alt="picture of best friends surrounded their college graduate friend" src={iphonegradAunty} />
        </ZigZag>
        <ZigZag>
          <Image alt="picture of colorful trees " src={iphonetreesbyEdgeofTheWorld} />
        </ZigZag>
        <ZigZag>
          <Image alt="picture of a jeep infront of a gloomy sky " src={iphonegloomy} />
        </ZigZag>
        <ZigZag>
          <Image alt="picture of dark cloudy city infront of a train station " src={iphoneflagstaffRailroad} />
        </ZigZag>
        <ZigZag>
          <Image alt="picture of some pretty colors  in the sky" src={iphoneflagstaffPrettyColors} />
        </ZigZag>
        <ZigZag>
          <Image alt="picture of a snowy neighborhood with pretty skies " src={iphoneflagstaffColorfulHouses} />
        </ZigZag>
        <ZigZag>
