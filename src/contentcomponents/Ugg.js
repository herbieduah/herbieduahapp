		...
		<Fragment>
			...
			<ContentShow more>
				<div className='container'>
					...
					<Paragraph>
						Email development sucks. Ask any developer who has development
						emails before and they will say the same thing. It usually took
						30-40 hrs to develop a new template for UGG that works on most email
						clients.
					</Paragraph>
					<Paragraph>
						I demoed an email framework called MJML to team. Once learned, you
						can build an email template before lunch. It also had some unique
						features like the ability to add an accordion, carousal, or text on
						an image. These features are somewhat easy to develop for web
						development but overlay complex on email on development.
					</Paragraph>
					<Paragraph>
