...
const workTools = "Adobe Creative Cloud, Microsoft SQL Server, Photoshop , Visual Studio Code";
    ...
    <ContentShow containerLarge more>
      ...
      <ZigZag>
        <Paragraph className="marginTopXLarge">
          Discount Tire Company is the largest tire and wheel retailer in the world. I am currently working there as a
          Front End Developer.
        </Paragraph>
        <Paragraph>
          My duties consist of developing and designing webpages for a legacy Intranet so unfortunately, I can't show
          any of my work on this web app.
        </Paragraph>
        <Paragraph>
          (If you really want to know, <Link href="mailto:herbduah@gmail.com">contact me</Link>)
        </Paragraph>
      </ZigZag>
      <ZigZag>
        <HeadingTwo>Modeling</HeadingTwo>
        <Paragraph>
          I also work as a model for Discount Tire ( It's an inside joke. I volunteered to be a model for one of their
          shoots).
        </Paragraph>
        <Figure
        ...
        <Figure
          ...
          <Figcaption className="marginBottomLarge">Why did the bike fall over? Because it was two tired.</Figcaption>
        </Figure>
        <Figure
          alt="A photo of me and another dude dressed as discount tire employees  in a shop just laughing it up"
          src={dtTeamworkTools}>
          <Figcaption className="marginBottomLarge">
            People should consider putting pedals on wheelchairs so that their arms don’t get tired.
          </Figcaption>
        </Figure>
        <Figure
          alt="A photo of me and another dude dressed as discount tire employees. The other dude looks disgruntled"
          src={dtPostedUp}>
          <Figcaption className="marginBottomLarge">When your friend is wheely tired of your tire puns.</Figcaption>
        </Figure>
        <Figure alt="a discount tire pamphlet" src={dtReceipt}>
          <Figcaption className="marginBottomLarge">
            Oh yeah I am on every receipt holder for their 1000+ stores nationwide so that's neat.
          </Figcaption>
        </Figure>
      </ZigZag>
