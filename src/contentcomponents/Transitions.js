...
const TransitionsPage = () => {
  return (
    <Fragment>
      <ContentShow less>
        <LessContent header={header}>You can choose how you bring the elements on this web app to life.</LessContent>
      ...
      <ContentShow containerLarge more>
        ...
        <ZigZag>
          ...
          <Paragraph>
            Animations bring the elements of this web app to life. I added an extensive collection of random animations
            for you to choose how you want to bring this web app to life.
          </Paragraph>
          <Small className="marginTopMed">Refreshing web app resets animation to default.</Small>
        </ZigZag>

        <ZigZag>
          <Small className="marginTopXLarge">
            Tip: After you choose an animation, navigate to a different page to see it in action.
          </Small>
          ...
          <div className="marginTopMed">
            <Paragraph>
              Shout out to <Link href="https://daneden.me/">Daniel Edens'</Link> amazing{" "}
              <Link href="https://daneden.github.io/animate.css/">Animate.css</Link> library.
            </Paragraph>
          </div>
        </ZigZag>
