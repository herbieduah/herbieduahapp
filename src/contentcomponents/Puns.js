...
const PunsPage = () => {
  ...
  const generatePun = () => setPuns(punArrayValues[Math.floor(Math.random() * punArrayValues.length)]);

  return (
    <div className="container">
      <Instructions className="marginTopLarge">Rotate device to see view web app.</Instructions>
      <PunGen pun={puns} />
...
const randomPun = punArrayValues[Math.floor(Math.random() * punArrayValues.length)];
