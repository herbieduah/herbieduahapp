		...
		<Fragment>
			...
			<ContentShow more>
				...
				<DisableSetting
					...
					<ShowIf noAnimation thisValue={navBarRight} thatValue={true}></ShowIf>
				...
				<Paragraph>
					...
					(I am thinking about adding a vulgar tone)
				</Paragraph>
				<HeadingThree>Technical Tone</HeadingThree>
				<ShowIf noAnimation thisValue={forDev} thatValue={false}>
					<Paragraph>
						Activate this if you recognize keywords such as: HTML5, ReactJS, UX
						Design, Prototyping, Javascript, CSS, User Interface, User
