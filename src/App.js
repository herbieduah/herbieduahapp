...
import SliderLine from "./maincomponents/Revealer/SliderLine";
import { FullScreenOverlay, NavBar, ShowIf, AppStartUp } from "./ComponentHelpers";
  ...
  return (
    <ThemeProvider theme={currentThemeObject}>
      <HerbieDuahApp
        ...
        {process.env.NODE_ENV === "production" ? <AppStartUp /> : null}
        {/* <AppStartUp /> */}
        ...
        <GlobalStyle />
        <NavBar />
        {isPortrait(ww, wh) ? null : <BorderDesktop className="hdapp__border" />}
        ...
        {!fullScreen && !showFSMobileHorizontal ? (
          <SplitPane
            ...
            defaultSize={parseInt(sessionStorage.getItem("splitPos"), defaultPaneSize(ww, wh))}
