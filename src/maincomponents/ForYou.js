    ...
    <Fragment>
      ...
      <div className="marginTopMed">
        <ShowIf noAnimation thisValue={"dherbstatwitter"} thatValue={whom}>
          <Paragraph>
            You know what's crazy? I am still not tired of MegTheeStallion twerking on the timeline.
            <ShowIf noAnimation thisValue={isMobileOnly} thatValue={true}>
              &nbsp; I know she is blessing the lil {mobileModel} you holding right now.
            </ShowIf>
        ...
        <ShowIf noAnimation thisValue={"linkedin"} thatValue={forYou}>
          ...
          <Paragraph className=" ">
            I'd like to say thanks. You could have been wishing your coworker or some connection you don't really know a
            happy work anniversary but instead you're here, checking out my web app.
          </Paragraph>
          <Paragraph className=" ">If you have any feedback please let me know.</Paragraph>
        </ShowIf>
        {/* Reddit */}
        <ShowIf noAnimation thisValue={"reddit"} thatValue={forYou}>
          <HeadingTwo>First Off</HeadingTwo>
          <Paragraph className=" ">
            I'd like to say thanks. You could have been upvoting some reddit post but instead you're here, checking out
            my web app. I really appreciate you. ()
          </Paragraph>
          <Paragraph className=" ">
            Shoutout to r/webdev, r/reactjs/ ,r/design_critiques and r/web_design/. (Also, this web app doesn't work in
            in-app browser)
          </Paragraph>
        </ShowIf>
    ...
    <Fragment>
      <ShowIf noAnimation thisValue={jobID} thatValue={forYou}>
        <Paragraph className="paddingLRParagraph">
          I appreciate you taking the time to check out my application and portfolio. Hope all is well at the {city}{" "}
          location.
        </Paragraph>
        <Paragraph>
          I believe I have the skills for your {job} position. I'll also love to support {company}'s mission to
          {topping}. I designed and engineered this portfolio with a role like this in mind. Looking forward to hearing
          from you.
        </Paragraph>
        {/* <Paragraph>
