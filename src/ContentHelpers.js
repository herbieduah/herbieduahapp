        ...
        {showMore ? (
          <CSSTransition timeout={revealSecs} classNames={transitionClasses}>
            <article className={`${containerLarge} more`}>
              <ScrollDownIndicator />
              <ShowIf noAbsolute thisValue={fullScreen && !minimalMode} thatValue={true}>
...
export const ElementReveal = (props) => {
  ...
  return (
    <Reveal effect={transitionValues.enterTransition} effectOut={transitionValues.exitTransition} duration={revealSecs}>
...
export const Instructions = (props) => {
  ...
  return (
    <ElementReveal>
      <small>
        <Text s format light tertiary className={`c-instructions paddingLRSm ${className} ${zigzag} ${center}`}>
          {props.children}
        </Text>
      </small>
    </ElementReveal>
...
export const ContentCategory = (props) => {
  ...
  const defaultIndex = props.category ? categoryArr.indexOf(props.category) : -1;
  return (
...
export const Emphasis = (props) => {
  ...
  return (
    <Fragment>
      <ElementReveal>
        <Text xxl {...props} className={`${className} ${lessClass} marginTopMed paddingLRSm`}>
          {props.children}
        </Text>
      </ElementReveal>
    </Fragment>
  ...
  return (
    <Fragment>
      <ElementReveal>
        ...
        <Text l {...props} secondary className={`${className} less__main-text paddingLRSm`}>
          {props.children}
        </Text>
      </ElementReveal>
    </Fragment>
...
export const Small = (props) => {
  ...
  return (
    <ElementReveal>
      <small>
        <Text m format light tertiary className={`marginBottomMed ${center} paddingLRParagraph ${className}`}>
          {props.children}
        </Text>
      </small>
    </ElementReveal>
...
export const HeadingOne = (props) => {
  ...
  return (
    <ElementReveal>
      <Text h1 xxl bold secondary className={`${className} marginBottomXLarge marginTopXLarge paddingLRSm`}>
        {props.children}
...
export const HeadingTwo = (props) => {
  ...
  return (
    <ElementReveal>
      <Text h2 l className={`${className} marginTopXLarge marginBottomSm paddingLRParagraph`}>
        {props.children}
        <ShowIf noAnimation thisValue={props.beta} thatValue={true}>
          <Text format s secondary light className="c-beta">
            Beta
...
export const HeadingThree = (props) => {
  ...
  return (
    <ElementReveal>
      <Text h3 l bold className={`marginTopMed marginBottomMed paddingLRParagraph ${className}`}>
        {props.children}
        <ShowIf noAnimation thisValue={props.beta} thatValue={true}>
          <Text format s secondary light className="c-beta">
            Beta
...
export const Image = (props) => {
  ...
  return (
    <ElementReveal>
      <Media type={imageLocation} src={src} alt={alt} className={`marginBottomMed ${className}`} />
    </ElementReveal>
  );
};
    ...
    <ElementReveal>
      <figure className={`marginBottomLarge`}>
        {mockup ? (
          ...
          <Fragment>
            <div className={className}>
              <Media type={imageLocation} width={props.width} height={props.height} src={src} alt={alt} />
            </div>
            {props.children}
          </Fragment>
        )}
  ...
  return (
    <ElementReveal>
      <figure className={`marginBottomMed ${className}`}>
        <Media type={videoLocation} width={props.width} height={props.height} url={url} desc={desc} />
        {props.children}
      </figure>
    </ElementReveal>
  );
      ...
      <ElementReveal className="themeCircle__container">
        <button className={`themeCircle__button ${currentClass}`}>
          <div className="themeCircle__overlay">
            {current ? (
              <Text format s tertiary bold className="themeCircle__current-text">
                Current
              </Text>
            ) : null}
            <Text format s tertiary bold className={`themeCircle__text ${currentClass}`}>
              {themeText}
            </Text>
          </div>
        </button>
...
export const TransitionTexts = (props) => {
  ...
  const currentClass = currentTransition === transitionValues.name ? "current" : "";

  return (
    <TransitionTextContainer onClick={changeTransition} className={`appTransition__item`}>
      <Text xs button className={`appTransition__container ${currentClass}`}>
        <span className={enterTextTransition}>{camelCaseHelper(transitionValues.enterTransition)}</span>
        {/* &nbsp;and&nbsp; */}
        <span className={exitTextTransition}>{camelCaseHelper(transitionValues.exitTransition)}</span>
      </Text>
    </TransitionTextContainer>
  );
};
  ...
  return (
    <ElementReveal>
      <ul className="appTransition" {...props}>
        {appTransitions.map(function (element, uniqueKey) {
          if (element.type === type) {
            return <TransitionTexts transitionValue={element.name} key={uniqueKey} />;
          } else {
            return null;
          }
        })}
