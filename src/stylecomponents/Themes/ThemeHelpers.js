...
const mainFontWide = `"rhode-wide", -apple-system, BlinkMacSystemFont, Oxygen, Ubuntu, Cantarell, "Open Sans", "Helvetica Neue", sans-serif`;
const mainFontExtraWide = `"rhode-extended", -apple-system, BlinkMacSystemFont, Oxygen, Ubuntu, Cantarell, "Open Sans", "Helvetica Neue", sans-serif`;
...
export const themeMaker = (theme = defaultBaseValues) => {
	...
	return {
		...
		buttonColorHoverFocus: `${rgba(fontColor, 0.6)}`,
		...
		navBarButtonColor: `${rgba(fontColor, 0.6)}`,
		...
		tabHeadingsColorHoverFocus: `${rgba(fontColor, 0.6)}`,
