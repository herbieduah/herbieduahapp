...
const mainFontWide = `"aktiv-grotesk-extended", -apple-system, BlinkMacSystemFont, Oxygen, Ubuntu, Cantarell, "Open Sans", "Helvetica Neue", sans-serif`;
const mainFontExtraWide = `"aktiv-grotesk-extended", -apple-system, BlinkMacSystemFont, Oxygen, Ubuntu, Cantarell, "Open Sans", "Helvetica Neue", sans-serif`;
...
export const themeMaker = (theme = defaultBaseValues) => {
	...
	return {
		...
		buttonBorder: `2px solid ${fontColor}`,
