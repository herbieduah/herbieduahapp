export const appBg = props => props.theme.appBg;
export const appBgAnimation = props => props.theme.appBgAnimation;
...
export const logoBgHoverColor = props => props.theme.logoBgHoverColor;
export const logoBorderRadius = props => props.theme.logoBorderRadius;
export const logoInnerFillColor = props => props.theme.logoInnerFillColor;
export const logoInnerFillColorHoverFocus = props =>
	props.theme.logoInnerFillColorHoverFocus;
export const logoOuterFillColor = props => props.theme.logoOuterFillColor;
export const modalFullScreenBg = props => props.theme.modalFullScreenBg;
export const modalFullScreenBgColor = props =>
	props.theme.modalFullScreenBgColor;
...
export const sliderCircleOpacity = props => props.theme.sliderCircleOpacity;
export const sliderLine = props => props.theme.sliderLine;
export const sliderLinePortrait = props => props.theme.sliderLinePortrait;
export const tabHeadingsBorder = props => props.theme.tabHeadingsBorder;
export const tabHeadingsBorderActive = props =>
	props.theme.tabHeadingsBorderActive;
export const tabHeadingsBorderBottomActive = props =>
	props.theme.tabHeadingsBorderBottomActive;
export const tabHeadingsBorderRadius = props =>
	props.theme.tabHeadingsBorderRadius;
export const tabHeadingsColor = props => props.theme.tabHeadingsColor;
export const tabHeadingsColorActive = props =>
	props.theme.tabHeadingsColorActive;
export const tabHeadingsColorHoverFocus = props =>
